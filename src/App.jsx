...
function Tribes({ campers, teams, generated, onGenerate, onMove, onAddCamper }) {
  ...
  return <>
    ...
    <section className="weights-panel"><div><span className="eyebrow">Criterios de balance</span><strong>Importancia relativa</strong></div><div className="weight-chips"><span>Edad + Velocidad <b>40%</b></span><span>Liderazgo <b>20%</b></span><span>Fuerza <b>20%</b></span><span>Creatividad <b>10%</b></span><span>Inteligencia <b>10%</b></span></div><small>La generación automática equilibra cantidades, programa y género; después puedes modificar manualmente sin restricciones.</small></section>
